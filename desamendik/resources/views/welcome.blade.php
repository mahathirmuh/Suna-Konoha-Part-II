...
<head>
  ...
  <title>Admin DesaMendik | Masuk</title>
...
<div class="login-box" style="background: #367fa9;">
  <div class="login-logo">
    <img src="{{asset('img/daya-taka-colour_burned.png')}}" alt="logo-paser" style="width: 20%; height: auto; margin-top: 15px;"><p style="color: white;"><b>Admin</b> DesaMendik</p>
  </div>
  <!-- /.login-logo -->
