    ...
    <div class="col-md-11" style="margin-left: 1px; width: 94%">
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          {!! Form::open(['url'=>'admin/struktur-organisasi-simpan','class'=>'form-horizontal', 'files' => true]) !!}
          @include('admin.struktur-organisasi.form')
          ...
          <div style="width: 100%; text-align: center;">
            ...
            <a href="{{url('admin/struktur-organisasi')}}" class="btn btn-warning pull-right" style="margin-top: 10px"> <i class="fa fa-arrow-left"></i> Kembali </a>
          </div>
          {!! Form::close() !!}
        </div>
      </div>
